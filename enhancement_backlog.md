...
### Phase 1: Core Functionality Fixes (Foundation)
...
3. **Test and fix GPIO event capture** - Validate existing infrastructure works
4. **Implement auto-start for MQTT listener** - Ensure reliability on boot/restart

### Phase 2: Immediate UX Improvements (Quick Wins)
